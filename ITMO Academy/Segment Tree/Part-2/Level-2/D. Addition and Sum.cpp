// D. Addition and Sum (https://codeforces.com/edu/course/2/lesson/5/2/practice/contest/279653/problem/D)
...
ll query(int l, int h, int i, int p, int q) {
    ...
    push(l, h, i);
    int m = (h-l)/2 + l;
    return query(l, m, lc, p, min(q, m)) + query(m+1, h, rc, max(m+1, p), q);
}
